...
PRE_TRANSLIT_OVERRIDES = {
    ...
    "катерпиллэр": "caterpillar",
    "катерпиллар": "caterpillar",
    "катерпилларс": "caterpillar",
    "катерпилларом": "caterpillar",
    "катерпил": "caterpillar",
    "катерпилла": "caterpillar",
    "катерпиларом": "caterpillar",
    "катерпиларс": "caterpillar",
    "cat": "caterpillar",
    "катерпиллары": "caterpillar",
    "caterpillar": "caterpillar",
    "caterpilar": "caterpillar",
    "caterpiller": "caterpillar",
    "caterpil": "caterpillar",
}
...
def detect_brands_in_query(
    ...
    """Return detected brand ids plus normalized and raw non-brand tokens."""
    ...
    for token in tokens:
        ...
        non_brand_terms.append(normalized)
        raw_non_brand_terms.append(token)
    return brands, non_brand_terms, raw_non_brand_terms, brand_raw_tokens
