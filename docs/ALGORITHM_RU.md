...
- **Шаг 1. Нормализация.** Убрали пунктуацию/повторы, ввели мини-словарь синонимов брендов, чтобы сразу ловить разговорные формы, и дополнили его популярными марками (Hyundai/Kia/Nissan/Ford/Mitsubishi/Volkswagen и т.п.) из выгрузки `manufacturer.txt`.
