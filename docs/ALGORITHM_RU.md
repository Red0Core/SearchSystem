...
- **Шаг 1. Нормализация.** Убрали пунктуацию/повторы, ввели мини-словарь синонимов брендов, чтобы сразу ловить разговорные формы, и дополнили его популярными марками из `manufacturer.txt`: от массовых (Toyota/Volkswagen/Hyundai/Kia) до премиальных (Lexus/Infiniti), а также грузовых и стройтехники (Kamaz/Komatsu/Doosan/Shantui).
